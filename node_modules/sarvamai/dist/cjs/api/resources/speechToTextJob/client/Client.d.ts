...
export declare class SpeechToTextJob {
     ...
     */
    getStatus(jobId: string, requestOptions?: SpeechToTextJob.RequestOptions): core.HttpResponsePromise<SarvamAI.JobStatusV1>;
    private __getStatus;
    /**
     ...
     */
    start(jobId: string, request?: SarvamAI.SpeechToTextJobStartRequest, requestOptions?: SpeechToTextJob.RequestOptions): core.HttpResponsePromise<SarvamAI.JobStatusV1>;
    private __start;
    /**
     * Start a speech to text bulk job V1
     *
